...
BASEPACKAGES=bos,uutf,fmt,camlp5.extprint,pcre,yaml,ipaddr,cmdliner,emile,uri,ptime
PACKAGES=$(BASEPACKAGES),camlp5.extprint,camlp5.extend,camlp5.pprintf,pa_ppx.utils,pa_ppx.base,pa_ppx.deriving_plugins.std,pa_ppx.base.link,pa_ppx.runtime,pa_ppx.testutils,sedlex
